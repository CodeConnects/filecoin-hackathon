...
export default function Challenge_3() {
    return(
        <Container className="md-container">
            ...
            <h4 className="text-center pb-4"><a href="https://medium.com/encode-club/nft-hack-challenges-c6bafddf30f7#660a" target="_blank">Challenge 3 ~ Embed an NFT</a></h4>
            ...
            <Row>
                <Col>
                    ...
                    <p className="break-text">React code:<br />
                ...
                <Col>
                    <NFTE className="border border-dark break-text" contract="0xb932a70a57673d89f4acffbe830e8ed7f75fb9e0" tokenId="17158"/>
                </Col>
            </Row>
